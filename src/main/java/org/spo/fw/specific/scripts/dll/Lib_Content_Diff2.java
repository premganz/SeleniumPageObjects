...
class CacheCommandPostProcess implements WebContentPostPcsCmd{
	Logger1 log= new Logger1(this.getClass().getCanonicalName());
	@Override
	public void execute(String pageName, String content, ServiceHub kw) {
...
public class Lib_Content_Diff2 extends Lib_PageLayout_Content{
	...
	public void init() {			
		...
		webContentProvider.setWebContentPostProcessor(new CacheCommandPostProcess());
	}
